...
func (ec *executionContext) field_Mutation_createBook_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewBook2githubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐNewBook)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createBook(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNBook2ᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_books(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNBook2ᚕᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBookᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_book(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOBook2ᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook,
		true,
		false,
	)
}
...
func (ec *executionContext) unmarshalInputNewBook(ctx context.Context, obj any) (model.NewBook, error) {
	...
	fieldsInOrder := [...]string{"title", "author", "year"}
...
func (ec *executionContext) marshalNBook2githubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v model.Book) graphql.Marshaler {
	return ec._Book(ctx, sel, &v)
}

func (ec *executionContext) marshalNBook2ᚕᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBookᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Book) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNBook2ᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNBook2ᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNNewBook2githubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐNewBook(ctx context.Context, v any) (model.NewBook, error) {
...
func (ec *executionContext) marshalOBook2ᚖgithubᚗcomᚋamitpoitrixᚋgoᚑgraphqlᚋinternalᚋgraphᚋmodelᚐBook(ctx context.Context, sel ast.SelectionSet, v *model.Book) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Book(ctx, sel, v)
